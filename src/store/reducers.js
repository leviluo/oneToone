...
// console.log(require('../components/Tips/modules/Tips').initialState)
// console.log(require('../components/headers/modules/headers').initialState)
...
const initialReducers = {
  ...
  register: (state = require('../routes/Register/modules/register').initialState) => state,
